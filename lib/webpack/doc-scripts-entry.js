    ...
    if (Array.isArray(docs)) {
      docs.forEach(function (path) {
        if (typeof path === 'string' && !paths[path]) {
          ...
          if (path.link && !paths[path.link] && path.depth <= 1 && (!path.children || path.children && !path.children.length)) {
      ...
      if (docs.link && !paths[docs.link] && path.depth <= 1 && (!path.children || path.children && !path.children.length)) {
