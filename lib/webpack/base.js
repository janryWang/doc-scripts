...
module.exports = {
  ...
  }), new webpack.ContextReplacementPlugin(/highlight.js\/lib\/languages$/, new RegExp("^./(javascript|jsx|bash)$"))],
  module: {
    rules: [{
      test: /\.jsx?$/,
      ...
      }, require.resolve('css-loader'), require.resolve('postcss-loader'), require.resolve('less-loader')]
    }, {
      test: /\.woff(\?v=\d+\.\d+\.\d+)?$/,
      ...
      }, require.resolve('css-loader'), require.resolve('postcss-loader'), require.resolve('fast-sass-loader')]
    }]
  }
};