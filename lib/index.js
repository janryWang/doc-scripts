...
var command = function command(options, webpackConfig) {
  ...
  _commander["default"].option("-i, --input <dir>", "Entry Directory").option("-o, --output <dir>", "Output Directory").option("-l, --lazy <boolean>", "Not Lazy depenedenies", true).arguments("<script>").action(_async(function (script, cmd) {
